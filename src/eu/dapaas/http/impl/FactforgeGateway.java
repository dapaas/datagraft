...
public class FactforgeGateway extends HttpGateway {
  private static final Logger logger = Logger.getLogger(FactforgeGateway.class);
  private CloseableHttpClient client;

  public FactforgeGateway(HttpMethod method, String url) {
    super(method, url);

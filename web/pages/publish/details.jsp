...
<h2 class="dataset-label">Data page properties</h2>
		...
		<div class="form-group">
			<label class="col-lg-2 control-label" for="description">Description:</label>
			 <div class="col-lg-10">
	             <div class="form-control-wrapper">
				<textarea id="description" name="description" class="form-control empty" rows="1" placeholder="Description...">${(wizard.action =='new') ? filename : wizard.details.description}</textarea>
				<span class="material-input"></span>
				</div>
				 <div class="checkbox">
	                    <label>
		...
		<div class="form-group">
			<label class="col-lg-2 control-label" for="keyword">Keywords:</label>
			<div class="col-lg-10">
            <div class="form-control-wrapper">
		...
		<div class="form-group">
			<label class="col-lg-2 control-label" for="licensing">Licensing:</label>
			<div class="col-lg-10">
            <div class="form-control-wrapper">
			<input type="text" id="licensing" name="licensing" class="form-control empty" value="${wizard.details.licensing}" placeholder="Licensing..."/>
			<span class="material-input"></span>
			</div>
			</div>
		</div>
		<div class="form-group">
			<label class="col-lg-2 control-label" for="usagerights">Usage rights:</label>
			<div class="col-lg-10">
            <div class="form-control-wrapper">
			<input type="text" id="usagerights" name="usagerights" class="form-control empty" value="${wizard.details.usagerights}" placeholder="Usage rights..."/>
			<span class="material-input"></span>
			</div>
			</div>
		</div>
		<div class="form-group">
			<label class="col-lg-2 control-label" for="bytesize">bytesize:</label>
			<div class="col-lg-10">
            <div class="form-control-wrapper">
			<input type="text" id="bytesize" name="bytesize" class="form-control empty" value="${wizard.details.bytesize}" placeholder="bytesize..."/>
			<span class="material-input"></span>
			</div>
			</div>
		</div>

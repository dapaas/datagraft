...
<div class="row">
	...
	<input type="hidden" id="id" name="id" />
		...
		<div class="col-lg-6 col-md-6">
			<template:latestdatasets id='catalogresult' col1="Data page" col2="User" col3="Published" col4="Portal" emptylabel="${emptylabel}" label="${titleDataset}" templateData="${datasetBean.getCatalogSharedDataset()}" />
		</div>
